         ...
         <span class="eng lang">ENQUIRY</span> <span class="chi lang">報名查詢</span> </div>
                ...
                <ul class="wrap contact-info">
                    ...
                    <li class="grid">
                        ...
                        <div class="txt">
                            學車快線：6511-3311<br> 服務熱線：8100-9228</div>
                        <div class="txt">電郵：<a href="mailto:info@a1driving.com.hk">info@a1driving.com.hk</a>
                        </div>
                    </li>

                    <li class="grid">

                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3690.5711273753204!2d114.15881786545289!3d22.3320538973837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x340400b34fe0ae47%3A0x360aaacf36277c50!2z5rex5rC05Z-X6ZW35rKZ54Gj6YGTMjY06Jmf6YeR6Lyd5aSn5qiT!5e0!3m2!1szh-TW!2shk!4v1511426539089" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>


                        <div class="txt">地址：長沙灣道264號<br> 金輝大樓地下B鋪</div>
                        <div class="txt">電話：2359-9009</div>
                    </li>

                    <li class="grid">
                        <!--<img src="<?php echo $base;?>images/contact05.png">-->
                        ...
                        <div class="txt">地址：土瓜灣美善同道1號<br> 美嘉大廈地下8號鋪</div>
                        <div class="txt">電話：2359-9192</div>
                    </li>
	...
	<td>A1 Driving</td>
                            ...
                            <tr>
                                ...
                                <td class="col-2">
                                    ...
                                    <!--  <input type="text" name="verifier_number" id="osolCatchaTxt0" class="inputbox required validate-captcha">
        <p><img src="./resources/classes/code.php"></p>-->
