...
<head>
	...
	<title>A1駕駛學校-超值學車，專業補鐘｜學車快線：6511 3311 / 2359 9192</title>
...
<?php include 'mmenu.php'; ?>
	...
	<div class="main-container">
		...
		<div class="header-blk">
			<div class="header">
				<div class="top-bar"> <a class="logo" href="./"><img src="<?php echo $base;?>images/logo.png"></a>
...
-->
        ...
        <span class="chi">報名查詢</span></a>
        			</li><li class="last"><a <?php if($pos=="registration" ) echo "class='active'";?>  href="<?php echo $base;?>registration#1"><span class="eng">REGISTRATION</span><br/>
