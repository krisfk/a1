...
//		
  ...
  midClick: true // allow opening popup on middle mouse click. Always set it to true if you don't provide alternative source.
    ...
    $('.enrollment-flow-btn').click(function(e){
        ...
        $('.flow-div').fadeIn(0);
        $('.exam-flow').fadeOut(0);
        $('.enrollment-flow').slideDown(200,function(){});
    ...
    $('.exam-flow-btn').click(function(e){
        ...
        $('.exam-flow').slideDown(200,function(){});
        $(this).css({'opacity':'1'});
		 ...
		 if($(this).hasClass('active'))
            {
			    ...
			    $('.show-lesson-map-div').fadeOut(0).slideDown(200,function(){});

            }
        else{
                $('.show-lesson-place-btn').html('顯示地圖');
			  $('.show-lesson-map-div').slideUp(200,function(){});
...
//		}
    ...
    $('.course-detail-btn').click(function(e){
        e.preventDefault();
        $('.expand-course-content').slideToggle(200,function(){});
        ...
        if(map_url === '')
            {
               ...
               $('#contact_timeslot').prop("disabled", true); // Element(s) are now enabled.
                ...
                $('.iframe-map').slideDown(200,function(){});
             //   prop("disabled", true);
    ...
    if($('body').hasClass('index'))
{
        ...
        $('.final-cost-div-inner-old .final-cost').html(final_cost);
