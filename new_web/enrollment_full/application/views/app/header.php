...
-->
        ...
        <span class="chi">主頁</span></a>
					...
					<!--<li><a   href="../news"><span class="eng">NEWS</span><br/>
        <span class="chi">最新消息</span></a>
					</li>-->
					<li><a href="../course"><span class="eng">COURSE</span><br/>
        <span class="chi">課程介紹</span></a>
					</li>
					<li><a href="../agent"><span class="eng">AGENT</span><br/>
        <span class="chi">代辦課程</span></a>
					</li>
					<li><a href="../company"><span class="eng">COMPANY</span><br/>
        <span class="chi">公司資訊</span></a>
					</li>
					<li><a href="../enquiry"><span class="eng">ENQUIRY</span><br/>
        <span class="chi">報名查詢</span></a>
					</li>
					<li class="last"><a class='active' href="https://www.a1driving.com.hk/enrollment/index.php/app/index/A1_Web_Enrollment"><span class="eng">REGISTRATION</span><br/>
        <span class="chi">立即報名</span></a>
					</li>
   ...
   <div class="breadcrumb">
   	<a href="../home">Home 主頁</a> > <a href="../registration">Registration 立即報名</a>
						...
						<div class="page-wrap">
							...
							<script type="text/javascript">
								$( function () {
									...
									var modify = url.searchParams.get("a");
