...
date_default_timezone_set('Asia/Hong_Kong');
	...
	if ( check_in_range( $start_date, $end_date, $date_from_user ) ) {
		echo '<a class="new-shop-banner" href="https://www.a1driving.com.hk/images/new-shop-banner.jpg" style="display: none;">.</a>
...
-->
        ...
        <span class="chi">主頁</span></a>
					...
					<!--<li><a <?php if($pos=="news" ) echo "class='active'";?>  href="<?php echo $base;?>news"><span class="eng">NEWS</span><br/>
        <span class="chi">最新消息</span></a>
					</li>-->
					<li class="menu-course-li"><a <?php if($pos=="course" ) echo "class='active'";?>  href="<?php echo $base;?>course"><span class="eng">COURSE</span><br/>
        <span class="chi">課程介紹</span></a>

						<!--					<a href="<?php echo $base;?>course-plus/" class="a1-plus-menu-btn"><img src="<?php echo $base;?>images/a1-plus-menu-btn.png"></a>
-->
					</li>
					<li><a <?php if($pos=="agent" ) echo "class='active'";?>  href="<?php echo $base;?>agent"><span class="eng">AGENT</span><br/>
        <span class="chi">代辦課程</span></a>
					</li>
					<li><a <?php if($pos=="company" ) echo "class='active'";?>  href="<?php echo $base;?>company"><span class="eng">COMPANY</span><br/>
        <span class="chi">公司資訊</span></a>
					</li>
					<li><a <?php if($pos=="enquiry" ) echo "class='active'";?>  href="<?php echo $base;?>enquiry"><span class="eng">ENQUIRY</span><br/>
        <span class="chi">報名查詢</span></a>
					</li>
					<li class="last"><a <?php if($pos=="registration" ) echo "class='active'";?>  href="<?php echo $base;?>enrollment/index.php/app/index/A1_Web_Enrollment"><span class="eng">REGISTRATION</span><br/>
        <span class="chi">立即報名</span></a>
				...
				<ul class="active-bar">
					...
					<li>
						<div class="color-bar <?php if($pos==" course " || $pos=="course course-plus " ) echo "active ";?>"></div>
					</li>
					<li>
