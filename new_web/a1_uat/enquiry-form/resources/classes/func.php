...
function emailToJoin($events_code, $course, $name, $phone, $email, $shop,$timeslot, $comment,$student_gender,$shop_email){
...
//		'age'=>$age,
//		'job'=>$job,
		'gender_title'=>$_LANG['gender_title'],
...
//    $headers .= 'From: <'.$_CONFIG['smtp_account'].'>' . "\r\n";
        $headers .= 'From: A1Driving enquiry sender <'.$_CONFIG['smtp_account'].'>' . "\r\n";
...
//mail($to,$subject,$message,$headers);
	...
	///////////////////////////////////////////
	 ...
	 $url = 'https://www.hksm.com.hk/sendmail/';
        //a1driving.com.hk <info@a1driving.com.hk>
//        echo "'to' => $to, 'from' => $from,'subject' => $subject , 'message' => $message , 'have_cc' => $have_cc,'cc'=> CC_EMAILS,$site_name=>SITE_NAME";
        $data = array('to' => $shop_email,
                            'from' => 'info@a1driving.com.hk',
                            'subject' => $subject ,
                            'message' => $message ,
                            'have_cc' => '1',
                            'cc'=> implode (", ", $_CONFIG['cc_email']),
                            'site_name'=>$subject);
...
//$_CONFIG['send_to_join_email'] = array('kayli@meg.com.hk');
    ...
    $cc_list =  implode (", ", $_CONFIG['cc_email']);
	$receiver = '<b>shop_email:</b><br/>'.$shop_email.'<br/>'.'<b>cc email:</b><br/>'.$cc_list;
//	echo $receiver;
	$name .= '<br/>['.$student_gender.']';
...
VALUES ('$date', '$IP', '$browser_name', '$events_code','$from','$receiver', '$course', '$name', '$phone', '$email', '$shop', '$timeslot', '$comment')";
