<div id="page-wrapper">
	...
	<div class="form-group">
			<label for="coupon_code_input" class="col-sm-2 control-label" style="margin-top:10px">顯示輸入優惠代碼(coupon code)</label>
			<div class="col-sm-10" style="margin-top:10px">
				<input type="checkbox" class="form-control" style="width:30px;height:30px;margin: 0;" name="coupon_code_input" value="1" <?php echo $info['coupon_code_input'] ? 'checked' : '';?> />
			</div>
		</div>
	
		<div class="form-group">
			<label for="ask_retake_part" class="col-sm-2 control-label" style="margin-top:10px">顯示重考部份seletion(repeater)</label>
			<div class="col-sm-10" style="margin-top:10px">
				<input type="checkbox" class="form-control" style="width:30px;height:30px;margin: 0;" name="ask_retake_part" value="1" <?php echo $info['ask_retake_part'] ? 'checked' : '';?> />
			</div>
		</div>
...
<!--    <div class="form-group">
			<label for="ask_megclub" class="col-sm-2 control-label" style="margin-top:10px">詢問登記查詢</label>
			<div class="col-sm-10" style="margin-top:10px">
				<input type="checkbox" class="form-control" style="width:30px;height:30px;margin: 0;" name="ask_reg_enquiry" value="1" <?php echo $info['ask_reg_enquiry'] ? 'checked' : '';?> />
			</div>
		</div>-->
    ...
    <div class="form-group">
			<label for="show_staff" class="col-sm-2 control-label" style="margin-top:10px">需要員工資料(corp offer)</label>
			<div class="col-sm-10" style="margin-top:10px">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="margin-top:10px">
				<input type="checkbox" checked class="form-control" style="width:30px;height:30px;margin: 0;" name="full_id" value="1" <?php echo $info['full_id'] ? 'checked' : '';?> />
			</div>
		</div>
		<div class="form-group">
			<label for="selected_course" class="col-sm-2 control-label" style="margin-top:10px">課程<br/><span style="font-size: 10px;">(Remarks: Value 對應select display content)</span></label>
			<div class="col-sm-10" style="margin-top:10px">
