...
})(window,document,'script','dataLayer','GTM-58978PC');</script>
			...
			<div class="header">
				<div class="top-bar"> <a class="logo" href="<?php echo $base;?>home"><img src="<?php echo $base;?>images/logo.png"></a>
                	...
                	<ul>
                        ...
                        <li>學車快線：6511-3311</li><li>服務熱線：8100-9228</li></ul>
				...
				<div class="list-app-list-blk">
					...
					<li><a href="https://www.a1driving.com.hk/app/ios/" class="app-link" target="_blank"><img src="../images/appstore-app.png"></a></li>
					<li><a href="https://www.a1driving.com.hk/app/android/" class="app-link" target="_blank"><img src="../images/google-play-app.png"></a></li>
					</ul>
                    </div>
...
-->
        ...
        <span class="chi">課程介紹</span></a>
					</li><li><a <?php if($pos=="agent" ) echo "class='active'";?>  href="<?php echo $base;?>agent"><span class="eng">AGENT</span><br/>
        <span class="chi">代辦課程</span></a>
        ...
        <span class="chi">公司資訊</span></a>
					</li><li><a <?php if($pos=="enquiry" ) echo "class='active'";?>  href="<?php echo $base;?>enquiry"><span class="eng">ENQUIRY</span><br/>
        <span class="chi">報名查詢</span></a>
        			</li><li class="last"><a <?php if($pos=="registration" ) echo "class='active'";?>  href="<?php echo $base;?>enrollment/index.php/app/index/A1_Web_Enrollment"><span class="eng">REGISTRATION</span><br/>
        <span class="chi">立即報名</span></a>
					</li>
					
				<!--	<li>
					<a <?php if($pos=="about" ) echo "class='active'";?>  href="javascript:void(0);" target="_blank">學生專區</a>
					</li>
				...
				<ul class="active-bar">
					<li class="first">
						<div class="color-bar <?php if($pos=="home") echo "active";?>"></div>
					</li>
				<!--	<li>
						<div class="color-bar <?php if($pos=="news") echo "active";?>"></div>
					</li>-->
					<li>
						<div class="color-bar <?php if($pos=="course") echo "active";?>"></div>
					</li>
					<li>
						<div class="color-bar <?php if($pos=="agent") echo "active";?>"></div>
					</li>
                    <li>
						<div class="color-bar <?php if($pos=="company") echo "active";?>"></div>
					</li>
					<li>
						<div class="color-bar <?php if($pos=="enquiry") echo "active";?>"></div>
					</li>
					<li class="last">
						<div class="color-bar <?php if($pos=="registration") echo "active";?>"></div>
					</li>
				</ul>
			</div>
