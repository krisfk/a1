    ...
    <div class="middle">
      <div class="section-title animated-text-blk">
		...
		<div class="enquiry-side-menu">
			...
			<ul>
			<li><img src="<?php echo $base;?>images/contact01.jpg" class="enquiry-side-menu-img"></li>
			
			<li><a href="javascript:void(0);" class="active enquiry-btn-a">A1 駕駛學校門市</a></li>
			<li><a href="javascript:void(0);" class="enquiry-btn-a">MEG 門市 <span class="small">(獨家銷售代理)</span></a></li>
			<li class="additional">
				
				<div class="text">
				學車快線： 6511-3311<br/>
服務熱線： 8100-9228<br/>
電郵： <a href="mailto:info@a1driving.com.hk">info@a1driving.com.hk</a>
		...
		<div>
				...
				<span class="shop-name">A1 深水埗總店</span><br/>
				地址：  長沙灣道264號 金輝大樓 地下B鋪<br/>
				電話：  2359-9009<br/>
				營業時間：  9:00am - 6:30pm[星期一至六]	11:00am - 6:00pm [星期日及公眾假期]<br/><br/>

			<?php
			date_default_timezone_set('Asia/Hong_Kong');
			
			
			if (new DateTime() > new DateTime("2018-08-06 00:00:00")) {

				
				?>
						<span class="shop-name">A1 土瓜灣分店暨電單車中心</span><br/>
				地址：   土瓜灣靠背壟道121號富裕閣F及G地舖 (落山道交界)<br/>
				電話：  2359-9192<br/>
				營業時間：  9:00am -  8:00pm[星期一至六]	  9:00am - 7:00pm [星期日及公眾假期]
			<?php
		...
		<div>
				...
				<span class="shop-name">MEG 銅鑼灣分店</span><br/>
				銅鑼灣軒尼詩道 502 號黃金廣場 15 樓 1503 室 (港鐵銅鑼灣站F出口)<br/><br/>

				<span class="shop-name">MEG 旺角分店</span><br/>
				旺角彌敦道 610 號荷李活商業中心 10 樓 1023 室 (港鐵旺角站E2出口，旺角百老匯戲院對面)<br/><br/>
			
				<span class="shop-name">MEG 荃灣分店</span><br/>
				荃灣青山公路 263 - 267 號力生廣場地下 G8-10 號舖 (港鐵站 A 出口)<br/><br/>
			
				<span class="shop-name">MEG 元朗分店</span><br/>
				元朗廣場2樓 266 號舖<br/><br/>
			
				<span class="shop-name">MEG 屯門分店</span><br/>
				屯門港鐵站TUM42號舖 (近港鐵站D出口)<br/><br/>
			
				<span class="shop-name">MEG 觀塘分店</span><br/>
				觀塘成業街 6 號 泓富廣場 13 樓 1309 室 (港鐵觀塘站 B1 出口)<br/>
			營業時間： 9:00am - 6:00pm[星期一至六及公眾假期，星期日休息]
			<br/>			
			<br/>			
