...
9.	完成網上登記後，本公司顧客服務中心將於14個工作天內聯絡學員親臨指定地點遞交身份證副本、住址證明 及 政府文件費用(學習駕駛執照申請費、運輸署考試表格費用 及 考試租車費)。
...
/*define('PAYPAL_USERNAME', 'test-facilitator_api1.meg.hk');
define('PAYPAL_PASSWORD', 'RWJNJGC9CVSSPGMK');
define('PAYPAL_SIGNATURE', 'AFcWxV21C7fd0v3bYYYRCpSSRl31Anwxmf1CrVJqyvBs15NfKj5FJVqJ');
*/

define('PAYPAL_USERNAME', 'test-store_api1.a1driving.com.hk');
define('PAYPAL_PASSWORD', '52JJRKMN4L9R33CS');
define('PAYPAL_SIGNATURE', 'Ac3lWF3t0knQsrRlkm1aPmHUx3qdA644Oss7R1l30EJzPuXFFqW9oA8S');

/*
Username:
test-store_api1.a1driving.com.hk
Password:
52JJRKMN4L9R33CS
Signature:
Ac3lWF3t0knQsrRlkm1aPmHUx3qdA644Oss7R1l30EJzPuXFFqW9oA8S
*/
 ...
 * For email
 */
//define('EMAILS', 'pingwong@meg.com.hk , carmenmok@meg.com.hk , epayment@meg.com.hk , megeportal@gmail.com');
//define('EMAILS', 'kayli@meg.com.hk');
define('CC_EMAILS', 'kayli@meg.com.hk');
