    ...
    word-wrap: break-word;">
					<thead>
						<tr>
		                    ...
		                    <th style="width: 108px;"><a href="<?php echo site_url('admin/apply_list/');?>?page=<?php echo $page;?>&sortby=pay_status&sortas=<?php echo $sortby=='pay_status'&&$sortas=='asc'?'desc':'asc';?>">付款狀態  <?php if($sortby=='pay_status')echo $sortas=='asc'?'<img src="img/down.png"/>':'<img src="img/up.png"/>';?></a></th>
		                    <th><a href="<?php echo site_url('admin/apply_list/');?>?page=<?php echo $page;?>&sortby=pay_status&sortas=<?php echo $sortby=='pay_status'&&$sortas=='asc'?'desc':'asc';?>">交易編號  <?php if($sortby=='pay_status')echo $sortas=='asc'?'<img src="img/down.png"/>':'<img src="img/up.png"/>';?></a></th>
							...
							<th width="200"><a href="<?php echo site_url('admin/apply_list/');?>?page=<?php echo $page;?>&sortby=e.name&sortas=<?php echo $sortby=='e.name'&&$sortas=='asc'?'desc':'asc';?>">活動名稱  <?php if($sortby=='e.name')echo $sortas=='asc'?'<img src="img/down.png"/>':'<img src="img/up.png"/>';?></a></th>
     ...
     <a href="<?php echo site_url('admin/apply_list/');?>?page=<?php echo $page;?>&sortby=contact_timeslot&sortas=<?php echo $sortby=='contact_timeslot'&&$sortas=='asc'?'desc':'asc';?>">聯絡時間	 <?php if($sortby=='contact_timeslot')echo $sortas=='asc'?'<img src="img/down.png"/>':'<img src="img/up.png"/>';?></a>                           
							 ...
							 <th style="color: #428bca;">Email(to student)</th>
		                    <th style="color: #428bca;">Email(to shop)</th>
		                    <th style="color: #428bca;">Email(cc)</th>
     ...
     <a href="<?php echo site_url('admin/apply_list/');?>?page=<?php echo $page;?>&sortby=remark&sortas=<?php echo $sortby=='remark'&&$sortas=='asc'?'desc':'asc';?>">備註	 <?php if($sortby=='remark')echo $sortas=='asc'?'<img src="img/down.png"/>':'<img src="img/up.png"/>';?></a>                           
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $val['pay_reference'];?></td>
							
							<?php
							$shop_email = $val['shop'];
							$shop_email = explode( '|', $shop_email );
							$shop_email=$shop_email[1];
							?>
