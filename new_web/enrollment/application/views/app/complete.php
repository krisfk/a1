        ...
        <tr>
          <td class="it"><p>&nbsp; </p>
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="result-table">
				...
				<tr>
				  <td class="bold">價錢：</td>
				  <td><?php echo '$'.$price;?><?php
	
	
			$addition_str='';
				    
					if($megclub_discount =='1')
					{
			//            $this->session->set_userdata("MEGCLUB_DISCOUNT",'1');
					...
					if($used_coupon!='0')
					{
						...
						echo $addition_str;											   
//	echo $megclub_discount =='1' ? ' (已扣除MEG Club 提供的會員折扣優惠$200)':'';
           ...
           <!--   <tr>
              ...
              <tr>
                ...
                <td align="left" valign="middle" class="txt01"><?php echo $this->retake_part[$retake_part];?></td>
                </tr>
				<?php
				 }
				?>
