...
define('MEG_CLUB_NOTIF_EMAIL','info@megclub.com.hk');
define('CC_EMAILS', 'patrickyeung@meg.com.hk,admin@hksm.com.hk');
define('EMAIL_SENDER', 'info@hksm.com.hk');
define('SITE_NAME', 'hksm.com.hk');
define('COMPLETE_REDIRECT', 'https://www.hksm.com.hk/');
