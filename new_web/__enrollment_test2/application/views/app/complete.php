        ...
        <tr>
          <td class="it"><p>&nbsp; </p>
			...
			<table align="center" border="0" cellspacing="0" cellpadding="0" class="result-table">
				...
				<tr>
				  <td class="bold">價錢：</td>
				  <td><?php echo '$'.$price?><?php echo $megclub_discount =='1' ? ' (MEG CLUB 會員優惠價)':'';?></td>
				</tr>
                <tr>
           ...
           <!--   <tr>
                ...
                <td align="left" valign="middle" ><?php echo $student_address;?></td>
                    ...
                    <tr>
                <td align="left" valign="middle" class="bold">選擇分店：</td>
                        <?php
                                $shop = explode("|", $shop);
                                $shop = $shop[0];
                        ?>
			 ...
			 <p align="center">&nbsp; </p>
            <p align="center" class="footer-statement">我們將有專人於14個工作天內*聯絡您核對個人資料及完成報名手續。<br/>
